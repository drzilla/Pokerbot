...
MANIFEST = {
    ...
    "_test_scratch.py": ("edc2e134f5a8660b5bce2b7f59eabc4876662c969a12cf2febf8c53a1b2e66c9", 830761, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("d8655a79fc9dc2e7887054f4c4ea50c376b66fc5a16c6cf03d21b6b8f6ae5d8d", 607914, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_coverage_builder.py": ("0a54bcaecde25f7a38d43b90a2c10a47dc7d17b475f1143202a397ba04f3fb28", 131680, "v8.14.1 REV5: re-jam key strips '+' + resolves at any depth (REJAM_MPvsUTG1, 72692569)"),
    ...
    "gem_report_data.py": ("234ae91a9ee019e52b1d3e364457fbd8dd1cb42b52eb8f51493c985942b29dc5", 228382, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
