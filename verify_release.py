...
MANIFEST = {
    ...
    "_test_scratch.py": ("0d9adaaf2c597646c20afc4f873e6c91d34e3e0679afd59a2acf78d8d75e8c47", 904823, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_draft/_html.py": ("621725671935678285a98925ba5f70b324826037919e9207902bfaa5264cd45c", 442470, "v8.18.1: full future-exploit sentence shown (title tooltip + wrap, no clamp/ellipsis); v8.18.0 signednum/dt-nocash + W1-A status pill preserved"),
    ...
    "gem_report_draft/sections_tournaments.py": ("55c23eaed564ac5435afb304372c2e8b1d088cd8a065b4cd565d444330dc81d4", 59096, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
