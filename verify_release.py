...
MANIFEST = {
    ...
    "_test_scratch.py": ("574c9260142134e27a7af65625ccc9a3653c4576fe7fc685528e59603fee31cb", 788691, "v8.18.0 W1-A: + T-W1A-01..11 (Final Decision Status precedence / verdict-code classifier / marker+auto-downgrade / secondary reasons never override / UNGRADED result-only / no-MISTAKE-without-error / serialization / pill-never-blank / contradiction gate catches+passes / ONE-owner stamp); REV16 base preserved"),
    ...
    "gem_report_draft/_html.py": ("56c8371eefe5fd42c89cf5355e64a2672c9e587fc60cf357c09586e269e03d6a", 425312, "v8.18.0 W1-A: .final-status-pill CSS (mistake/conditional/cleared/ungraded, desktop+mobile) + the sticky topbar mirrors the canonical status pill + the inline-whitelist passes final-status-pill"),
