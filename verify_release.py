...
MANIFEST = {
    ...
    "_test_scratch.py": ("bfa009f8b4ea232c83d717aa732df93dca9cadbfe7e483492330bc6c63c57b54", 645380, "v8.17.1 Iter-1 REV3: + T-I1F-01..26 decision-time bounty (prefix invariance, cover!=eligibility, exhaustive truth table), folded dead-money pot layers, and gate-catches-injected-bug tests"),
    ...
    "gem_analyst_worklist.py": ("21cf2087db5ddba87aa1b7e315dad207165215dd08f9925fb138f46e4b566e97", 61164, "v8.17.1 Iter-1 REV3: bounty_context consumes the ONE canonical FUTURE-BLIND build_decision_bounty_context (eligibility + stack-cover are separate fields; one typed aggregate/reason)"),
    ...
    "gem_decision_snapshot.py": ("3ed989e4bb7cab8a0ab41363473075141d2c19aa56fe7c38e9b00740de7d9264", 41360, "v8.17.1 Iter-1 REV3: + build_decision_bounty_context (future-blind decision-time owner), _classify_bounty (one typed aggregate/reason), _contest_pot_layers (folded dead money in the pot, reconciling layers); realized accessors no longer fall back to the stack-cover map"),
    ...
    "gem_report_draft/sections_xiv.py": ("347f0e42df9c45b1ad93fe93d44b54f987e75c8da1da38eb2fab3d5d84e0c61a", 243590, "v8.17.1 Iter-1: bounty-math note distinguishes an uncontested jam (no confrontation) from a genuine data gap (canonical contesting_count)"),
