...
MANIFEST = {
    ...
    "_test_scratch.py": ("c6a94e3c4eef1d7e2a2733ef8ba5d8f2d55302924c2e8467ad3fb69aeaf08a5c", 615643, "v8.17.1 Iter-1 corrective: T-DS rebuilt as the 13 mandatory adversarial production-path tests (no-future snapshot, mixed bounty, 3/4/5-bet + overjam taxonomy, postflop remaining stacks, dead-short participant)"),
    ...
    "gem_analyst_worklist.py": ("746bd5405b8ab6f829c26235db1158a89aff5eab0fe4b8c4cf4a8c1f69cfa500", 58579, "v8.17.1 Iter-1 corrective: preflop-allin is_call accepts the full canonical action-kind taxonomy (call_vs_jam / call_off)"),
