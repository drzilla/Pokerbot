...
MANIFEST = {
    ...
    "_test_scratch.py": ("40023786363bd21955067c864f817c4de3a53149c4df5c2e3a56675dd8e3cc3f", 889496, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("9ce14890738fea4cd47b34414f9c2a1a7b827fd3b7455cebe5cc991e5869d7b4", 612328, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
