...
MANIFEST = {
    ...
    "_test_scratch.py": ("4d3829e0ecde1e9e046a668c4cc68d3feb3cb958a9d0f66d61322391af608713", 827935, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
