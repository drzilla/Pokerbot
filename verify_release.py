...
MANIFEST = {
    ...
    "_test_scratch.py": ("78389542c677f42c81e511b63a3a4fecbdf2194c73719d99492c5d35b3fdc97c", 845616, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_data.py": ("7cb4442301b28ceb5e31d87271e53f3292dd3aa6574116f35266f2f75d82bf8d", 230628, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
    ...
    "gem_report_draft/draft.py": ("242ffc930451d8f01830304482ce55bf976aa6210eacd9d300627f9062e72d3f", 39562, "v8.17.1 P5: _build stamps rd[canonical_verdicts] before sections render"),
    ...
    "gem_report_draft/sections_iv_xii.py": ("3baddda3051395cbe5b39f4a1d0a88fa50482aecb8789a2861b0531ffa8761a8", 226225, "v8.16.0 villain: matrix Teaching Signals wording"),
    "gem_report_draft/sections_mistakes.py": ("523809ec7f6b9923fa2f0ae93f117ec227a78d3b0a24a29f94c33ad69803e3e7", 124924, "v8.14.0 Slice E rev-2: PKO opportunity table rename (Opportunity/Wrong/Missed)"),
