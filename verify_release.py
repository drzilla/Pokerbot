...
MANIFEST = {
    ...
    "_test_scratch.py": ("b5d412b24ee232fb45d8294b154459a7c75a5cd00aeceb14e5e7f736cc2d56c7", 861923, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_draft/sections_tournaments.py": ("b0b1ead72a2998c5e894fac09b61ec1a52f0d0a9daf6c229bf90d41a3a913bff", 49448, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
