...
MANIFEST = {
    ...
    "gem_report_draft/sections_xiv.py": ("9001009dba2fb073b584a008dc92575284ecfc28f22a6989bb00885c3b2ab255", 280651, "v8.17.1 Iter-1 REV13 C2: the XIV.A + XIV.B equity blocks suppress 'Hero equity vs range' for a forced short all-in (no decision-range grade); REV12 Read-capsule + re-jam relabel preserved"),
