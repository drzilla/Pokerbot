...
MANIFEST = {
    ...
    "_test_scratch.py": ("9d29809f5dfc2ea7dc69dff8d486d5f2f18a13922fbe6c5f6392047dd697b3db", 711766, "v8.17.1 Iter-1 REV10: + T-REV10-01..13 (canonical node taxonomy, no-decision, fold callable, worklist serialization parity failure-injection, metamorphic)"),
    ...
    "gem_coaching_cards.py": ("2ec9af7b6f5319ab9d8a65fc1d27841a2b407fe35f267d6d0d2acc8dcf5b10a1", 52169, "v8.17.1 Iter-1 REV10 B7: decision_content_ownership records full per-action ownership (street/action/node/price/bounty/range/verdict); whole-hand fields marked"),
    ...
    "gem_decision_snapshot.py": ("7f40c4f84afd692c5ab80390195faaa07aa69d775fa9fcfa1476e18d40e5878b", 85854, "v8.17.1 Iter-1 REV10: canonical_node_type taxonomy + serialize_reviewed_decision_node + no_hero_decision + canonical_effective_decision_depth_bb + first_in_limp + fold callable display"),
    ...
    "gem_report_draft/sections_xiv.py": ("f11a0746871cdcf5f91b7700f92bddf4ab29c3c3363961604b17c504403a592f", 276719, "v8.17.1 Iter-1 REV10: canonical actual_node_type ownership + _ACTUAL_CHART recommended-alternative purpose + reviewed_range_ownership (worklist==report) + no-decision suppression + canonical visible depth"),
