...
MANIFEST = {
    ...
    "_test_scratch.py": ("771506dd2921f88cbfdada93a1813f13984844de24e0a2ee52c08794de1d001b", 844890, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
