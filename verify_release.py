...
MANIFEST = {
    ...
    "_test_scratch.py": ("7f2590f37fcc44412f1220193b96467276b6598009479703e57c76dfc2ef6483", 823228, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("4aab74160a8e9ad16a2d076bcb88d4692679c36455cbd0079c095aab8d7bb05c", 603859, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_report_draft/_html.py": ("30ee5ba910bc479a43e7f4aac52e4cdb59d80b95153e7dd8700528b1204da0b6", 433763, "v8.18.1: full future-exploit sentence shown (title tooltip + wrap, no clamp/ellipsis); v8.18.0 signednum/dt-nocash + W1-A status pill preserved"),
    ...
    "gem_report_draft/sections_tournaments.py": ("0ace42fed35b0fc83db830a0030bc7c3b35dd9ef6ff43dd28478904db0cc82c0", 48396, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
    ...
    "gem_report_draft/tldr.py": ("bbbfa28d2da99f2e029cf4e52e2a6b9b1d3bea4e996579366c9d9da209480124", 150651, "v8.17.1 P5: review-queue stamps canonical_verdict; rq-row carries data-canonical-verdict"),
