...
MANIFEST = {
    ...
    "_test_scratch.py": ("f4d202f4b286620a153a9b0e02371a83fbd185f5cdb3b4349d26e581f107020c", 861527, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_draft/sections_tournaments.py": ("124552247e936c8e2749ddba50c9109d9c32975080999295ab1097d9c5878ee9", 49039, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
