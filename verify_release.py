...
MANIFEST = {
    ...
    "_test_scratch.py": ("598f325ce32b93e27085199e6cb25c7d8a1f080ab1c69d6e9d6c81e049b0d16e", 891540, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("e5803bf1dcb4b07e41e00b1acefc56e18532ae4ed4092fd6578929e0194822fc", 616166, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_report_draft/sections_tournaments.py": ("99d6f8230dbe50449a7c969aafd0c1c5017636c32f4a35aec7ed019a52f50f79", 56342, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
