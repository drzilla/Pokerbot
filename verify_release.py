...
MANIFEST = {
    ...
    "_test_scratch.py": ("ef8f52d1763b61eeb9a2013d2fa0f454c17584c5f1a98792622edec9c9b53dd6", 913814, "v8.21 Runout Transition: T-V25-15 _hand_grid.py freeze pin re-pinned for the wiring; T-RC-BIND-01 v8.20.0 identity preserved"),
    ...
    "gem_analyst_worklist.py": ("6c6a585b410873ceb932412b562dbbc67786217dc75c3397e3ec6961198aa656", 69345, "v8.17.1 Iter-1 REV10 A1/B8: exported decision_node is serialize_reviewed_decision_node (canonical ReviewedDecisionView) + reviewed_decision_view; legacy builder retired to a stack-less fallback"),
    "gem_analyzer.py": ("06e5c4a5adf097f17c54071c348431b971f812562d20cc7fe977cd8bd9b25463", 625610, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_commentary_capsule.py": ("582f02590d82cf000566a988354273b084ae2dc1baa5bc9607353d3c29f07635", 20047, "v8.17 Epic A: commentary capsule layer (registers + evidence tiers + capsule builder + content lints L1-L13)"),
    ...
    "gem_input_manifest.py": ("1766f7fc541ddbc530844549359f1ad6649040179a24b150371d5ea743a05216", 7660, "v8.19.0 Chapter I input manifest"),
    ...
    "gem_parser.py": ("a5f4ce2d9c33dae17de8aadbacc3b3d2a1cd73c489cae77af58fd67807046d50", 107054, "v8.17.1 Iter-1 REV15 B: the ledger preserves a TYPED post_type (ante / small_blind / big_blind) from the raw hand-history text at the parser boundary — the canonical source downstream code reads (never re-inferred by amount/seat)"),
    ...
    "gem_tournament_model.py": ("47577d1021533dcd694d406641da18f4e53800b8b2c71d2799710d0c300e5ab1", 26726, "v8.18.0 final product-truth: _finish_state shows place/field+Top% for every valid finish (No cash is a RETURN outcome, never the finish); classify_speed types every event STANDARD/TURBO/HYPER with a source"),
    ...
    "gem_report_data.py": ("7e7b6f8d7cae50e0daf49d2ab9953fd226d72e175b315e9e6adebfb977a3919a", 234023, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
    "gem_report_draft/_hand_grid.py": ("d325263ffefbc8aa9c6d8d6197dd139258533e5e812d1ea01ecd1e41afe972b0", 98750, "v8.21 Runout Transition wiring re-pin: REV16 §6/§8.5 grid sizing preserved + additive _attach_runout_transition (hand-arg thread-through) injecting the descriptive turn/river note into the existing per-street note collection"),
    "gem_report_draft/_helpers.py": ("1d5bcea3dc57b193651b5f4e7f28fd61eebfbdc2c3a7398e450ec73ee6cd16c4", 72083, "v8.18.0 W1-A: build_canonical_verdicts stamps cv['final_status'] (the ONE canonical Final Decision Status, derived via gem_final_status); P5 verdict resolver preserved"),
    "gem_report_draft/_html.py": ("3c11e4d666dee70f19a6d2d95c1380eee6a48b9144b881f7c193c1fd719716ff", 446033, "v8.18.1: full future-exploit sentence shown (title tooltip + wrap, no clamp/ellipsis); v8.18.0 signednum/dt-nocash + W1-A status pill preserved"),
    ...
    "gem_report_draft/draft.py": ("9bfa0158f44f2cb018014db0c3c2f248f43fd40749ad0991955ba3080a65005c", 43615, "v8.17.1 P5: _build stamps rd[canonical_verdicts] before sections render"),
    "gem_report_draft/sections_financial.py": ("78063803f2a10f6dd76a8bed43f037abfd4ecaa586dfec2680c9b047df42d286", 133314, "v8.14.3 Issue 1+2: cash+ticket basis footnote + large-loss verdict relabel when ANALYST_COMPLETE"),
    ...
    "gem_report_draft/sections_iv_xii.py": ("4e27766cd7798524a2894daadbcb787da14cde8a9ea76a7ac0c004394d1cad13", 227384, "v8.16.0 villain: matrix Teaching Signals wording"),
    ...
    "gem_report_draft/sections_tournaments.py": ("6288725012f3cd9638309b05753fe5f438b93cfe677b0112909e6abfdf1dd592", 63104, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
    ...
    "gem_report_draft/sections_xiv.py": ("20182ad08dd8fd3c3c7f9318ea36df03ffc850cfcf69fc2f3f11f1717f0eb636", 286095, "v8.21 Runout Transition wiring re-pin: v8.18 status-pill paths preserved; the four _split_argument_into_notes call sites thread the hand object + a fallback derives the deterministic turn/river note when no analyst/aggression note exists (AUTO_ONLY == analyst-integrated for the same hand)"),
    "gem_report_draft/tldr.py": ("fb73ade8dd057d39a2161a3ffd60082ab36d0b6276a0ab6163ff1faa24c6ff88", 154961, "v8.17.1 P5: review-queue stamps canonical_verdict; rq-row carries data-canonical-verdict"),
    ...
    "gem_tournament_finality.py": ("f8e95f34274d149c075fded9ffff7932fb0a531bb9363ff788bc8a11719c4c42", 20456, "v8.20 Iter2 Outcome1: canonical event/bullet/exit finality model for Tournament Results -- one typed record per tournament (Day-1 flights merge), final event exit = last resolved bullet (never invented for unresolved/advanced), 7 deterministic fixtures + reconciliation invariants"),
    ...
    "gem_discovery_context.py": ("de62593cba5500c782ad0b17f6f3b473860b2093bafb40c9a91477b9e9a0d2d5", 30825, "v8.20 Iter2 Outcome2: context-rich mistake discovery -- 3 families (turn over-barrel / river curiosity / river value) on COMPLETE canonical context (reuses gem_parser/gem_made_hands/gem_board_state; no new evaluator); genuine-value guard prevents board-two-pair false positives; fail-closed review; honest product-value gate"),
    "gem_analyst_packet.py": ("5c4ef450c535499cfdf3b51219b8449a6517caede48d4eb69277f4f8ae8c50a8", 48729, "v8.20 Iter4: the ONE sealed self-contained analyst packet + fail-closed validator -- required/optional queues, keyed owner-rule/chart evidence (no per-hand dup), all calcs pre-completed (no Chat-side equity/EV/SPR), manifest session+hash binding; validator rejects unknown/dup/out-of-enum/missing-required/wrong-binding/unpacketed-numeric"),
    ...
    "gem_sizing_detector.py": ("d3390d9dc7d4d709219c11d234bc61114f488d0e666dddbf62ea9b1713b52071", 10093, "v8.20 W1A: bet-sizing detector v1 — wraps the flop-c-bet sizing engine into bounded aggregate leak signals"),
