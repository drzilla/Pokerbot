...
MANIFEST = {
    ...
    "_test_scratch.py": ("233231e3db11fbcbc46825c853529fbaf820a9ea73164c2e83711594d728f6de", 811273, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_tournament_model.py": ("dcc26e79eae8a8da826df02bf562ee78969e7fd051bebb31f4f6d0cdea0bfdf9", 23796, "v8.18.0 final product-truth: _finish_state shows place/field+Top% for every valid finish (No cash is a RETURN outcome, never the finish); classify_speed types every event STANDARD/TURBO/HYPER with a source"),
    ...
    "gem_report_draft/sections_tournaments.py": ("73b247005a3b22cc9110363a2aa265c72c07be76032048dfbd3062ce85d4d3c9", 45496, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
