...
MANIFEST = {
    ...
    "_test_scratch.py": ("c41bda09c6767aab0bb0357886d1ca846a51501c3a11962c23e522cfb4d1c57d", 801065, "v8.18.0 final product-truth: + T-VT18-03/04 (eligibility before completeness; missing future_exploit is incomplete-eligible not ineligible; derived future_exploit concrete) + T-VT18-05 (signednum kind) + T-VT18-06 (speed classifier); T-TT-R-11 updated to place/field+Top% finish"),
    ...
    "gem_report_draft/_html.py": ("7d7de5d699b58c5c05b2e18440c486c01979c83bb30925f0a5b7096a1fae2afb", 433485, "v8.18.0 final product-truth: _dtFmt signednum (non-currency signed number for BB/100, cEV/100) + .dt-nocash return-cell style; W1-A final-status-pill preserved"),
    ...
    "gem_villain_teaching.py": ("d19b4841993a59e1dd87568afc7dd65e439a2e0670b8291b5f5ec7a033093260", 54107, "v8.18.0 final product-truth: eligibility (q1-q5) decided BEFORE completeness (q6/q7); missing future_exploit = incomplete-eligible not ineligible; derive_future_exploit completes the 133; typed INELIGIBLE_REASONS; dedup by (villain,decision)"),
