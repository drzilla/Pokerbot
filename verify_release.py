...
MANIFEST = {
    ...
    "_test_scratch.py": ("25e7982c6751f0afbd47cf75e016eb2175858541261a77408e8abec92af31b3f", 871331, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
