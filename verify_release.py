...
MANIFEST = {
    ...
    "_test_scratch.py": ("eb9aaf1ad6269528924db2855f5850e0dc41daaa09358e95e1ae1d32d0f651b5", 829453, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
