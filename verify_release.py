...
MANIFEST = {
    ...
    "_test_scratch.py": ("594d1a2ba348bb0f57ba3377865cc533f7af33fdc66677eedd737cb5333b540f", 728134, "v8.17.1 Iter-1 REV12: + T-REV12-01..11 (strict oracle node check, ActionSizingContract, legacy-verdict/CVJ suppression failure injection, action-row parity, coaching ownership labels)"),
    ...
    "gem_decision_snapshot.py": ("bb50d4b26c7b63d5f8db841d0b54c718955a85aa4145b6b2be9d9d0348c4830c", 93858, "v8.17.1 Iter-1 REV12 A: build_action_sizing_contract (added/total-to/continue/raise-increment/extra-isolation); a BB-option raise is an open, not a check_option node"),
    ...
    "gem_report_draft/_hand_grid.py": ("b8d42cc60a648570180ed3b9f815b2b357c6ee6a4b5056484dbd555bdaf7061c", 89395, "v8.17.1 Iter-1 REV12 C1/A2: the grid suppresses the push-verdict for a short all-in and labels a re-jam JAM as adds X / all-in to Y"),
    ...
    "gem_report_draft/sections_xiv.py": ("db1b8b64248c57614abcfa9c66a0a4a343b02936e54dc24b21c38329fe2159b0", 279998, "v8.17.1 Iter-1 REV12 C1/D2: the Read capsule suppresses the call-verdict + 8BB-proxy range for a short all-in; a canonical re-jam is relabelled from Wide CVJ to a subordinate continue-component"),
