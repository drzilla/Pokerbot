...
MANIFEST = {
    ...
    "_test_scratch.py": ("f00e13775c5a1c0f9f18dda648bff01e0143963fd9ac7c339696763d3318ccab", 678677, "v8.17.1 Iter-1 REV6: + T-LU-01..10 ledger-uncalled, T-B2-01..09 visible-decision routing + failure injection, T-B34-01..09 combined exact+potential applicability + certainty + auto-clear"),
    ...
    "gem_analyzer.py": ("fc3fae1febe94822d46f2720d4db4e9de006eb8a58f0861034d12d2106e11d50", 595510, "v8.17.1 Iter-1 REV6: stamps the ledger-inferred reviewed_decision_ref onto every hand (visible decision routing independent of render path)"),
    ...
    "gem_decision_snapshot.py": ("35e2a922d5cb75f11def42c5becfb3eea96e67a03d738de93f37e566513b92d7", 56678, "v8.17.1 Iter-1 REV6: _ledger_uncalled (ledger-derived uncalled returns), build_reviewed_decision_ref + infer_reviewed_action_index (canonical visible routing), exact_and_potential applicability + bounty_certainty"),
    ...
    "gem_report_draft/sections_xiv.py": ("2700e4530d83d2c555be49aaf2df01f0fdec7d4753a27e0c4241b10f4580679e", 256431, "v8.17.1 Iter-1 REV6: XIV.A + XIV.B capsule/pot-odds route through the canonical reviewed-decision ref (visible Reviewed-decision line + data-decision-action-index); combined exact+potential bounty disclosure"),
...
CANARIES = [
    ...
    ("gem_analyzer.py", "'bounty_covers_villain': bool(_dbc_default and _dbc_default.get('hero_covers_relevant_villain'))",
     "v8.17.1 Iter-1 REV4 B2: the icm bounty flag derives from the canonical context, not the realized scalar"),
