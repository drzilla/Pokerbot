...
MANIFEST = {
    ...
    "_test_scratch.py": ("b532acbc86f2fcd4800d00f7cfc2bb52a4a659dd1bb5d3836f7ca1b66f2840f1", 597835, "v8.17.1 Iter-1: +20 T-DS production-path tests (canonical decision snapshot: temporal board, dead-short exclusion, contesting count, bounty coverage, action kind); blocker tests declare decision street"),
    ...
    "gem_analyst_worklist.py": ("614b4f00e0e1c5f909073dc3bcb4bb8e38f7905b6cea41ce7336b00f1f03b377", 50234, "v8.17.1 Iter-1: preflop-allin action kind from canonical snapshot (raise over an already-all-in villain == call_vs_jam, not rejam)"),
    "gem_analyzer.py": ("b60a0a53ca25ee11fde9ff7b146a10a0754b14896a4aa9ab895d51b61a89d155", 591381, "v8.17.1 Iter-1: bounty_collectible from canonical contesting-opponent coverage (resolves jammer_stack_bb==0 false-unknowns whether Hero jams/calls/multiway)"),
    ...
    "gem_decision_snapshot.py": ("bcf8210df5cc451a858571d532937ea0d4715f413f1daac594a9d0d29df49e20", 7450, "v8.17.1 Iter-1: canonical decision-time snapshot (board_at_decision, relevant_opponents, contesting_count, relevant_effective_stack, bounty_coverage, hero_action_kind; dead-short exclusion)"),
    "gem_parser.py": ("6b8dc058dce49811a5b6b4be7454fca690fbcbbb47d1b66ab6e5c696af92d7c7", 104026, "v8.17.1 Iter-1: eff_stack_bb_at_decision excludes already-all-in dead shorts (shared DEAD_SHORT_MAX_BB)"),
