...
MANIFEST = {
    ...
    "gem_report_draft/sections_xiv.py": ("4242653f13e92b750cc5a9d0db8fbcf445a9052cd751d3b450d57a55985583f5", 285272, "v8.21 Runout Transition wiring re-pin: v8.18 status-pill paths preserved; the four _split_argument_into_notes call sites now thread the hand object so the descriptive turn/river note is injected"),
