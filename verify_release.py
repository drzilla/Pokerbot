...
MANIFEST = {
    ...
    "_test_scratch.py": ("1780ad75a8b055670895d7133fd689c41c51be86127d4da73d774ebaf770a303", 736731, "v8.17.1 Iter-1 REV13: + T-REV13-01..13 (typed sizing amount_added vs raise_increment, independent sizing oracle, numeric row check failure injection, node/view deep parity, UNGRADED short all-in eligibility, re-jam bounty wording)"),
    ...
    "gem_decision_snapshot.py": ("f25cacd53e8eb2425753027e394b21694625b305478c228e02506895f894dd3c", 96592, "v8.17.1 Iter-1 REV13 B2/A4/C3: _canonical_price_contract shared by view+node (deeply equal, callable null off-price); action_sizing_contract on view+node; decision_grade_eligibility (short all-in UNGRADED)"),
    ...
    "gem_report_draft/_hand_grid.py": ("677a5d59cb7bdff235949c4048de3371a2fa94915aa2d756cac1810194f6b20e", 90718, "v8.17.1 Iter-1 REV13 A1/C1: the grid labels a Hero all-in's 'adds X' from amount_added_bb (never the raise increment) + total_to; suppresses the 👍 on a forced short all-in"),
