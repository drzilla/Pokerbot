...
VERSION = "v8.14.1-preview"   # v8.14.1 real-report QA hotfix (preview)
...
MANIFEST = {
    "GEM_Changelog.txt": ("c2809f424fbdc4d8711398ee5fe74ae3f45179f1706c38d5ceea40db8e4a42fe", 69168, "v8.14.1-preview hotfix entry (+rev-2 review-list add-on)"),
    ...
    "_test_scratch.py": ("87fec85a3dffbb4cb62ab2a0250521e567853964a064e0a178895f5651a36251", 382400, "v8.14.1 rev-2: +T-H141-12..18 review-list cosmetics (1060 tests)"),
    ...
    "gem_analyzer.py": ("ae6c7e20f16a803392ac2a1a3417530fa8f9b3ebc1c8095e312ed89199997ad5", 555260, "v8.14.1 hotfix: manifest runtime version + report-format ver + run-log"),
    ...
    "gem_pko_research.py": ("ed475bab34244886e72809d41fa9da2c9a7b200234dbf6157bb83f9b11d8ec77", 49773, "v8.14.1 hotfix: multiway confident->Review downgrade + explicit threshold-unavailable"),
    ...
    "gem_report_draft/_html.py": ("b99da9e68a47c22bd75839a2185dedbfa317897504bf6e3b33babfea720e79e0", 379789, "v8.14.1 rev-2: reviewed-list Hero cards + section-review label + collapse-caret toggle"),
    ...
    "gem_report_draft/sections_financial.py": ("d952ccf5cae68102cef0d0e0fdefc821b1b5d31e6a92528b346d612276444997", 129253, "v8.14.1 hotfix: cash-settlement (session-end) date label"),
    ...
    "gem_report_draft/sections_xiv.py": ("db78ed337b8a7b96ea02b5a813741eb95c3c9942af31bd19ac7eaa642e6e9490", 182164, "v8.14.1 hotfix: chart labels in Range-check + required-equity teaching copy"),
    "gem_report_draft/tldr.py": ("3ac8b3e8db0af1fbec41b3f1b5ff93ec46da5e9227ded18e3bed34a96e8303d6", 143413, "v8.14.1 rev-2: reviewed/completed list collapsed-by-default caret affordance (+ rev-1 cEV/queue)"),
...
CANARIES = [
    ...
    ("gem_version.py", "RUNTIME_VERSION = 'v8.14.1-preview'",
