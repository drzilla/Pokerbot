...
MANIFEST = {
    ...
    "_test_scratch.py": ("c9617cc8f4ee6e76c61ee17b34431b7d6b41866c14d64081590c83eeadd3cd54", 873824, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_draft/sections_tournaments.py": ("52dca28ff3812046b38b18635c29cd648419cbdf6f7b85faa7f7f61943d83331", 54466, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
    ...
    "gem_tournament_finality.py": ("b944c8fcd3cf00f06abbbdde47bcf1d90a449d25865546f38c558daa4826204c", 15329, "v8.20 Iter2 Outcome1: canonical event/bullet/exit finality model for Tournament Results -- one typed record per tournament (Day-1 flights merge), final event exit = last resolved bullet (never invented for unresolved/advanced), 7 deterministic fixtures + reconciliation invariants"),
