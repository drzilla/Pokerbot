...
MANIFEST = {
    ...
    "_test_scratch.py": ("7f908e9f38415df9638958aa34588522c5b9ab23eb3a88b62effd94764b58550", 721513, "v8.17.1 Iter-1 REV11: + T-REV11-01..15 (postflop-bet kind, covering re-jam literal, underblind short all-in, non-price contract, independent oracle, failure injection, metamorphic)"),
    ...
    "gem_analyzer.py": ("d643b70abee8fc30efbab9391d296829b44bd24ad71cdb0b3907f994d08d448d", 596729, "v8.17.1 Iter-1 REV6: stamps the ledger-inferred reviewed_decision_ref onto every hand (visible decision routing independent of render path)"),
    ...
    "gem_coaching_cards.py": ("d9d9b8289e6043a0c5dd58756ba27477648b62df9ec49e07a5d162fa6fc1a314", 54222, "v8.17.1 Iter-1 REV11 F1: decision_content_ownership SERIALIZED onto the coaching card with an ownership class (selected_action / earlier_context / population_research / whole_hand)"),
    ...
    "gem_coverage_builder.py": ("379a7cb1e2ec232a707f641bf9814dda80c680eb95f3c60b37164928c96a958a", 128851, "v8.14.1 REV5: re-jam key strips '+' + resolves at any depth (REJAM_MPvsUTG1, 72692569)"),
    ...
    "gem_decision_snapshot.py": ("9baaace5e56733692d860874b8f91c72c534308b4631f694d5dc4d19d75f516b", 89925, "v8.17.1 Iter-1 REV11: postflop bet kind=bet; covering re-jam (no collapse to call); first-in short_all_in / first_in_short_all_in; became_all_in_on_this_action; raw price null for non-price + faced_voluntary_price_bb"),
    "gem_parser.py": ("db7cbe1a32e41137b0cfdba6229e90930ce753f2f517f64e66429b38455da017", 104946, "v8.17.1 Iter-1 corrective: ledger records added_bb (exact per-action commit) + seat_stack_by_player; eff_stack_bb_at_decision derived from the ONE canonical snapshot (no independent min-stack walk)"),
    ...
    "gem_report_draft/_hand_grid.py": ("feb8dc717cec29d92179fb727d534c2c808bb20bf50b04688d8df297d1235c79", 87513, "v8.17.1 Iter-1 REV11 E1: the action grid renders Hero rows from the canonical action-semantic (Complete/Limp/short-all-in) and suppresses pot-odds for non-price actions"),
    ...
    "gem_report_draft/sections_xiv.py": ("2a289d9474b536acafca5351b0b5867befaf4b113245091d7d0bce20946dc8b9", 276942, "v8.17.1 Iter-1 REV11: first_in_short_all_in node ownership (suppressed range); the legacy verdict auto-suppresses for short_all_in (not in _ALLIN_REVIEW_KINDS)"),
