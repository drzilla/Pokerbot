...
MANIFEST = {
    ...
    "_test_scratch.py": ("78b26ef6a17ad1afe545128e676ab5cb8e61410f6a9d70c1e352de9652e3e2dc", 902680, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_draft/sections_tournaments.py": ("3585927d9e01873eb72605ab86655c0bae713360e802bbebea9023485ea38aff", 56853, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
