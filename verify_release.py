...
MANIFEST = {
    ...
    "gem_report_draft/_html.py": ("ca6cba3f000885ecf7cec93c702339438d4c97b5216e737230d62173ffb1a847", 438481, "v8.18.1: full future-exploit sentence shown (title tooltip + wrap, no clamp/ellipsis); v8.18.0 signednum/dt-nocash + W1-A status pill preserved"),
    ...
    "gem_report_draft/_datatable.py": ("2d2676fad829b431b9473fd76cf22abd53608602bc3d27ed96e6c0d9ce89b7cc", 10151, "v8.18.0 final product-truth: + 'signednum' kind = non-currency signed number (BB/100, cEV/100) with fmt_signednum + sign class; DataTable foundation (typed columns, kind-aware null-last sort, filters, totals, sticky, hand/link cells)"),
    ...
    "gem_report_draft/sections_tournaments.py": ("88a62a77b3f3890acbcaff50827c85107579ca9e90d2b64d12933f10e741dc2a", 48592, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
