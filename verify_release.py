...
MANIFEST = {
    ...
    "_test_scratch.py": ("dc5ac5fc1110c31465a67077d97407d84011a7d4ced6a9068d3a9cadb16b4cf9", 876102, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_tournament_finality.py": ("fa91394a4fc89c75e74f1ae4a73b61bf07f56482ce03d22a04643a5584fb12ae", 17791, "v8.20 Iter2 Outcome1: canonical event/bullet/exit finality model for Tournament Results -- one typed record per tournament (Day-1 flights merge), final event exit = last resolved bullet (never invented for unresolved/advanced), 7 deterministic fixtures + reconciliation invariants"),
