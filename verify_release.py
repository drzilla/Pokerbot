...
MANIFEST = {
    ...
    "_test_scratch.py": ("b7dfe16eff8ac82eba7dda788fd3bca1d1593e7cb90dfa643307b32e8865be00", 826469, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_draft/_helpers.py": ("194777411a2a5fd902769dd49039f5575e7d75d91edd71018c2c02aeba568721", 71577, "v8.18.0 W1-A: build_canonical_verdicts stamps cv['final_status'] (the ONE canonical Final Decision Status, derived via gem_final_status); P5 verdict resolver preserved"),
    "gem_report_draft/_html.py": ("fab2de85ed178d30f0c526493f5faf59e169af777ec2f8ec2c048d3a1171b778", 437593, "v8.18.1: full future-exploit sentence shown (title tooltip + wrap, no clamp/ellipsis); v8.18.0 signednum/dt-nocash + W1-A status pill preserved"),
