...
MANIFEST = {
    ...
    "_test_scratch.py": ("62df13f33afc8e14725a444349659e5df26e72fa37fbd90b7e0076034418d804", 826794, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("0c60448c4167146be740b104151d1275320b84ef988f63cc323505460d85007f", 607566, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_report_data.py": ("80a1c64d9df8fb701e185ff774b6012197a75c6864f7ca3ffd2a18a06866df94", 226819, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
    ...
    "gem_report_draft/sections_xiv.py": ("c96eb9531bb60fa8e36b3578b26af73598fe3b97d71bf1c776ecaa40e04cb2aa", 284609, "v8.18.0 W1-A: both hand-detail-card paths stamp data-final-status + render the canonical status pill (primary) and drop the redundant verdict-nuance pill; REV13 C2 short-all-in suppression preserved"),
    "gem_report_draft/tldr.py": ("7be752c4e0ef1b73df95fd11527c01c314cc877a0b6febc8f4dcb95f5bff884b", 150750, "v8.17.1 P5: review-queue stamps canonical_verdict; rq-row carries data-canonical-verdict"),
    ...
    "gem_ranges.py": ("dce9073be4099255c16a0d16f02562bb1a198cc0ed4f5d36461cc66cd30d45e7", 54971, "v8.17.1 P2: build_range_evidence + shared open/jam chart selector (range-lens single source of truth)"),
