...
MANIFEST = {
    ...
    "_test_scratch.py": ("a31c9452f2566913e679f1c62343a0d7728023f666687e749803238d6944cd75", 913141, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("2c413222f257c4166e79197e4affc3eea78c93f39c031c8d619f53934dd33587", 624492, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_report_draft/draft.py": ("33501502e0dd3aaf48a650ca0b2269363daa6ff9181af235be59b2459a87ec4b", 42754, "v8.17.1 P5: _build stamps rd[canonical_verdicts] before sections render"),
