...
MANIFEST = {
    ...
    "_test_scratch.py": ("91950baeeeeb60fe22ac942f607e6f33b96434e4efb261a7fd3827c58a382a00", 848754, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
