...
MANIFEST = {
    ...
    "_test_scratch.py": ("72eb382d3b597ef9f0741879320a77f389657a7779188fd29ca84ce4f89f509f", 782599, "v8.18.0 W1-A: + T-W1A-01..11 (Final Decision Status precedence / verdict-code classifier / marker+auto-downgrade / secondary reasons never override / UNGRADED result-only / no-MISTAKE-without-error / serialization / pill-never-blank / contradiction gate catches+passes / ONE-owner stamp); REV16 base preserved"),
    ...
    "gem_report_draft/_html.py": ("e5ccb2933af54afb46ab61d7d89fcdb1e699e72dacaa4e8bb3eac378ac8ab507", 423831, "v8.18.0 W1-A: .final-status-pill CSS (mistake/conditional/cleared/ungraded, desktop+mobile) + the sticky topbar mirrors the canonical status pill + the inline-whitelist passes final-status-pill"),
    ...
    "gem_report_draft/sections_xiv.py": ("61538fba62c2991a89702a9548d5f8d8428e0d9ef3c181fe58c533f5f75bb3f6", 283367, "v8.18.0 W1-A: both hand-detail-card paths stamp data-final-status + render the canonical status pill (primary) and drop the redundant verdict-nuance pill; REV13 C2 short-all-in suppression preserved"),
    ...
    "gem_final_status.py": ("56b5db54c746e2c9148396fc44b06cdf1ee7995f576fc4c3882ffc4e06e1f413", 15067, "v8.18.0 W1-A: the ONE canonical Final Decision Status owner (MISTAKE/CONDITIONAL/CLEARED/UNGRADED + separate secondary reasons) -- typed, serialized, with the single status-pill HTML producer; derived from the canonical verdict + decision-snapshot gradeability, never the result"),
    "_qa_status_consistency.py": ("3106225bf346e6362c51937176a2ccacfccee8240e56c6841771631676c919f5", 6874, "v8.18.0 W1-A: the status-contradiction gate (run_status_consistency) -- every hand exactly one status; no CLEARED/UNGRADED shows a mistake pill; pill==card; reports the distribution"),
