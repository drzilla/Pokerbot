...
MANIFEST = {
    ...
    "_test_scratch.py": ("0663b04868d501531dae995883dde4c8f11c9f35c5e1101dd58120861d50667e", 798053, "v8.18.0 W1-A: + T-W1A-01..11 (Final Decision Status precedence / verdict-code classifier / marker+auto-downgrade / secondary reasons never override / UNGRADED result-only / no-MISTAKE-without-error / serialization / pill-never-blank / contradiction gate catches+passes / ONE-owner stamp); REV16 base preserved"),
    ...
    "gem_tournament_model.py": ("fd9d0b35e4a8a31a2497ee7e9dde3feaf82259a232111aaec6088c1ac6ea4b8d", 21877, "v8.17.1 P4: event performance(hands/bb100) + reviewed + exit_hand fields for Tournament Tables v3"),
    ...
    "gem_report_draft/_html.py": ("378e4c3e023b641d67589f625951b2ffebb46ffd25d6b04fb72f46d905317532", 433309, "v8.18.0 W1-A: .final-status-pill CSS (mistake/conditional/cleared/ungraded, desktop+mobile) + the sticky topbar mirrors the canonical status pill + the inline-whitelist passes final-status-pill"),
    ...
    "gem_report_draft/_datatable.py": ("d84bad71eb04bf7c14262246e46f66338872ea565c36b3c4a978b86fe54453ea", 9647, "v8.18.0 DataTable foundation: typed columns + kind-aware sort (null-last) + filters + totals/aggregates + sticky + canonical hand/link cells; Tournament Results consumes it"),
    ...
    "gem_report_draft/sections_tournaments.py": ("d87b487ab5c9af5273038b239dac2c652deadcbe44827f4c83fd20ec3380b46a", 43799, "v8.17.1 P4: Tournament Tables v3 -- 7 surfaces (grouped aggregates, distribution chart, filters/sticky, Finance&Finish, Performance, drivers rollup) unified into one Tournament Results block"),
    ...
    "gem_villain_teaching.py": ("b25022081db8e605295b57c5e46fba5f1189d8583dcc8ce8bbec2bb4130f97f4", 49568, "v8.16.0 villain: status-safe cards + grade gate + calibrated node-specific mixed/split caveat + ICM caution"),
