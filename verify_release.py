...
MANIFEST = {
    ...
    "_test_scratch.py": ("4cde4ec30f786a24e669af15da4ecc4e8e7611088cc309e8e2087686ddca2b4b", 807145, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("6cb23c11eafe6c4e889b3da975cc58628e53c90d94be26d906c78b2ea5ca3027", 597455, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_commentary_capsule.py": ("b5037b4356e0d107d32a4edc66674587802a11d283c3bbf5a8d9bbb330928450", 16612, "v8.17 Epic A: commentary capsule layer (registers + evidence tiers + capsule builder + content lints L1-L13)"),
    ...
    "gem_tournament_model.py": ("9b41389dfa70a82d52081881e437f5c0a18b95aa222981c4a9b5a7df9650b283", 23172, "v8.18.0 final product-truth: _finish_state shows place/field+Top% for every valid finish (No cash is a RETURN outcome, never the finish); classify_speed types every event STANDARD/TURBO/HYPER with a source"),
    ...
    "gem_report_draft/draft.py": ("abcc8c645302c6ecea7bbe290f189e2c33562423d657ed0d2db7eef905554f12", 36395, "v8.17.1 P5: _build stamps rd[canonical_verdicts] before sections render"),
    ...
    "gem_report_draft/sections_tournaments.py": ("d312acd94439a458bae418dcf7ade0d4882d960427676f387c35cfd39bdf2a43", 45247, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
    ...
    "gem_report_draft/sections_xiv.py": ("520ade6dc870635b140338fcb4738b2e12e767e7ffa5c6d7c08ac3cdcc3833dc", 283766, "v8.18.0 W1-A: both hand-detail-card paths stamp data-final-status + render the canonical status pill (primary) and drop the redundant verdict-nuance pill; REV13 C2 short-all-in suppression preserved"),
