...
MANIFEST = {
    ...
    "gem_report_data.py": ("028b4cd94ffa212d1bc2c449edf06f005a682c00c9df613ce811da6319b53035", 229885, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
