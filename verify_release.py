...
MANIFEST = {
    ...
    "_test_scratch.py": ("098cadc85dc7a3907951a760a9c228ee3b064ffe97fab774e924f3c65f6980c9", 910000, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("b6e89e6e313d650182abd7c04d9c6802309229af86eab9e2b62436ed3781fec2", 622967, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_report_draft/_html.py": ("7cecea0e550189148f47d47ef963ee8289471df60aedbea2ea803b20108210af", 445583, "v8.18.1: full future-exploit sentence shown (title tooltip + wrap, no clamp/ellipsis); v8.18.0 signednum/dt-nocash + W1-A status pill preserved"),
    ...
    "gem_report_draft/draft.py": ("3ea1f5dcbcf3c6a734d386b9ccc7bbe2d21fd20d8a4c146ba0fb50408520b261", 42326, "v8.17.1 P5: _build stamps rd[canonical_verdicts] before sections render"),
    ...
    "gem_report_draft/sections_tournaments.py": ("f0034566aedb898541d980d749a418f4dc56c9e9c2d073bd4313febd28277cf7", 59549, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
