...
MANIFEST = {
    ...
    "_test_scratch.py": ("c214fdb73af34da6df11160cf8eaddec68528c781c2bdefe676f74c7ff24c77b", 848041, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_data.py": ("8b502f792612337d58e60aef967541c85214e536ef465996bae09b4d28baf699", 231748, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
    ...
    "gem_report_draft/sections_mistakes.py": ("88c2e3b2da16f696ebced7d13e270f3a359906561f0683b43536c35f279d5837", 125520, "v8.14.0 Slice E rev-2: PKO opportunity table rename (Opportunity/Wrong/Missed)"),
