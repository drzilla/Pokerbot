...
MANIFEST = {
    ...
    "_test_scratch.py": ("f070be4a01a5c17e5aec01f207c9038cc603b45b4a9917c0ba552ed159073fc1", 687066, "v8.17.1 Iter-1 REV6: + T-LU-01..10 ledger-uncalled, T-B2-01..09 visible-decision routing + failure injection, T-B34-01..09 combined exact+potential applicability + certainty + auto-clear"),
    ...
    "gem_decision_snapshot.py": ("e39e37709636296fe632162c37390b5275cfa86f1ff1b7d62cf488154c4177e2", 66489, "v8.17.1 Iter-1 REV6: _ledger_uncalled (ledger-derived uncalled returns), build_reviewed_decision_ref + infer_reviewed_action_index (canonical visible routing), exact_and_potential applicability + bounty_certainty"),
    ...
    "gem_report_draft/sections_xiv.py": ("a689ec3d31cca9caa8e4d29819491396dc3b106f9fd0aa1cf080448a8c1948a5", 262980, "v8.17.1 Iter-1 REV6: XIV.A + XIV.B capsule/pot-odds route through the canonical reviewed-decision ref (visible Reviewed-decision line + data-decision-action-index); combined exact+potential bounty disclosure"),
...
CANARIES = [
    ...
    ("gem_report_draft/sections_xiv.py", "Reviewed decision:",
     "v8.17.1 Iter-1 REV6 B2: the VISIBLE reviewed-decision line (street/call/depth) the rendered-parity gate parses"),
