...
MANIFEST = {
    ...
    "gem_report_draft/_hand_grid.py": ("4d555582d3b2ca59d834723f5613ba117d27e61d1e93cd728feffe68bb1c5cea", 77947, "v8.14.1 rev-3: human chart labels + call-jam reconciled vs analyst + depth caveat"),
    "gem_report_draft/_helpers.py": ("8a1c5c412835121148f80e78185b2550c58742e00918c28bb80895fcc8db4fed", 56572, "v8.14.1 rev-4: Correct-range chart label"),
    "gem_report_draft/_html.py": ("9531ff535dc65d810fc29606a3366fe2b6ee25d1a0d28397e8e4cee7e52b51f4", 379955, "v8.14.1 rev-3: all-auto-clear queue count label + modal title follows header"),
