...
MANIFEST = {
    ...
    "_test_scratch.py": ("e497c0d2a47aecce9b85da41c90dd5082b02b5e97b7a58ac61e5730d0eda52ed", 858032, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
