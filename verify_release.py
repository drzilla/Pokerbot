...
MANIFEST = {
    ...
    "_test_scratch.py": ("7c011551986150c3e6f7fefc951c85d454f2d256d9b5f7f237bee0b0df534653", 855311, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_report_draft/_helpers.py": ("6ddb9c70e9b47126784c749ec2ebd7d06d0fd0e4b1007a97da1a65cb3c5a6d11", 71683, "v8.18.0 W1-A: build_canonical_verdicts stamps cv['final_status'] (the ONE canonical Final Decision Status, derived via gem_final_status); P5 verdict resolver preserved"),
    ...
    "gem_report_draft/draft.py": ("f2fc9cee6fdb205cae36c737b6362ce143d17395a1277365c311f77c1c34c8e8", 39974, "v8.17.1 P5: _build stamps rd[canonical_verdicts] before sections render"),
    ...
    "gem_report_draft/sections_mistakes.py": ("8687eeef3ee0db73323bd318bee20e7a01802777badaaeb056220763b8acd05a", 125829, "v8.14.0 Slice E rev-2: PKO opportunity table rename (Opportunity/Wrong/Missed)"),
