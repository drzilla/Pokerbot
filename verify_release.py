...
MANIFEST = {
    ...
    "_test_scratch.py": ("60789a5c80a7aefc39e662a30b094b0892dfe592c0f0e8a91ad2a5a09d4bba6b", 812490, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("d5689e767c65982ddcaf38879ce3acb10fb02b99d55cffd858aa37986f430bef", 599363, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_report_data.py": ("cf5e6de7ee27c87def636ab4576e87307571b268a2c8da463219a017cb0fea87", 224581, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
