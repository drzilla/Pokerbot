...
MANIFEST = {
    ...
    "_test_scratch.py": ("b3704b0a0b62ce4562fd90c124114719f791f9940ca044277a6ad13b2c02b021", 817850, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("aacdfaaedf6792dbb6b1dad1bb0dbee4cf154490b0c23e455968a5797a503e6e", 601526, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_commentary_capsule.py": ("813cd4756ca2a08ee35f582fe2dbd993471f3300c5e160c4fed072b9ff43800a", 17456, "v8.17 Epic A: commentary capsule layer (registers + evidence tiers + capsule builder + content lints L1-L13)"),
    ...
    "gem_report_draft/sections_tournaments.py": ("b1e1d4f87041b17292bab6c788b548d9198d2be99be244d53a44e411d84d5a4d", 45690, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
