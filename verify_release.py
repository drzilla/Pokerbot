...
MANIFEST = {
    ...
    "_test_scratch.py": ("8bda5f6009832e28f21cd27a13c0d520daa6ba60553e030b08a4d4bafba3cc12", 743599, "v8.17.1 Iter-1 REV14: + T-REV14-01..08 (forced-post ante-dead/blind-live, all-in exhausts stack, call adds callable no raise increment, contestable required equity, persisted view==node parity, raw-callable privatized)"),
    ...
    "gem_decision_snapshot.py": ("55c8868635c69ce8d1f3bddaea875de3a1ab56d48e18fcee4bad8ff57fd2f52b", 105296, "v8.17.1 Iter-1 REV14 A/B/C: build_forced_post_context (ante dead vs blind live); live_street_committed_before; ActionSizingContract derives amount_added canonically (all-in=stack_before/call=callable), live total-to, no call raise increment; raw snapshot callable privatized off-price"),
...
CANARIES = [
    ...
    ('gem_decision_snapshot.py', 'amount_added = hero_before',
     "v8.17.1 Iter-1 REV14 B/C: an all-in's amount_added EXHAUSTS the stack (stack_after=0); a call adds the callable"),
