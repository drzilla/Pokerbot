...
MANIFEST = {
    ...
    "_test_scratch.py": ("9fea29307040e7b98eb54a373bb54e3f757c216fe5089e30b602edaab746ad46", 700800, "v8.17.1 Iter-1 REV6: + T-LU-01..10 ledger-uncalled, T-B2-01..09 visible-decision routing + failure injection, T-B34-01..09 combined exact+potential applicability + certainty + auto-clear"),
    ...
    "gem_analyst_worklist.py": ("c2358e566b7de3ebf18156e4027f5e769c8dc3a789e6a73b33bf9dc1bf5204eb", 64591, "v8.17.1 Iter-1 REV6: stamps the canonical reviewed-decision ref (decision_kind-aware) into report_data; auto-clear blocks on exact_and_potential / material-unknown bounty certainty"),
    ...
    "gem_coaching_cards.py": ("c7bf056e7a09b14bbc4f831262abc2354cfe140f85c617b59a427c2c4fa4da41", 50309, "v8.17.1 Iter-1: blocker uses board_at_decision (no future-board reads); multiway uses canonical contesting_count (not table size); pko_pressure pinned to preflop"),
    ...
    "gem_decision_snapshot.py": ("6a91fa4c1da0c722b20cda530b53a9a482c74384f05f82994121857b3bc59ef8", 72222, "v8.17.1 Iter-1 REV6: _ledger_uncalled (ledger-derived uncalled returns), build_reviewed_decision_ref + infer_reviewed_action_index (canonical visible routing), exact_and_potential applicability + bounty_certainty"),
    ...
    "gem_report_draft/sections_xiv.py": ("5173f40c819afe184dcfcd95861cf6eebd7225f3d3ffd2f7fe2f988eb7908234", 271514, "v8.17.1 Iter-1 REV6: XIV.A + XIV.B capsule/pot-odds route through the canonical reviewed-decision ref (visible Reviewed-decision line + data-decision-action-index); combined exact+potential bounty disclosure"),
