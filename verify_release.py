...
MANIFEST = {
    ...
    "_test_scratch.py": ("8366b5ad0855edd21047710196a01e95a36c4b3f29ec9b04774d8a79992c25de", 864536, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
