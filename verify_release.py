...
MANIFEST = {
    ...
    "_test_scratch.py": ("84e64cdc08885c7eb3445f87e1ff907ec283b2bd0558293a2018ae192d329012", 911667, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_analyzer.py": ("f553aaf5ce85317371276419a5f53b05ff7f19e93c723bea229159bea2a58375", 623900, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
