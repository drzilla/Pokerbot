...
MANIFEST = {
    ...
    "_test_scratch.py": ("76da9d9447c4d34051d90321888697764c9aa83dd5663d7f481eaaf0046356f7", 841005, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
    ...
    "gem_coverage_builder.py": ("8e8941ad67a74ffa1ede32538f7d30ded1e6a8faea47a6f0ee245075159630f1", 132658, "v8.14.1 REV5: re-jam key strips '+' + resolves at any depth (REJAM_MPvsUTG1, 72692569)"),
    ...
    "gem_report_draft/draft.py": ("79b736e6565c655e6371c80cbfdefc13a928077d8b5fe21cc6beaae57b0c9121", 36588, "v8.17.1 P5: _build stamps rd[canonical_verdicts] before sections render"),
