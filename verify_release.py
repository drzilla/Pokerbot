...
MANIFEST = {
    ...
    "_test_scratch.py": ("24fa1cccc1101559c7c7db1043a9d20e440bb43e56636fe76dce9b067728ed03", 606462, "v8.17.1 Iter-1 corrective: T-DS rebuilt as the 13 mandatory adversarial production-path tests (no-future snapshot, mixed bounty, 3/4/5-bet + overjam taxonomy, postflop remaining stacks, dead-short participant)"),
    ...
    "gem_analyst_worklist.py": ("5a0935df2635e363c5f4a3cc1ec5bf3f9d9744b644da9256902b9661947b6653", 57849, "v8.17.1 Iter-1 corrective: preflop-allin is_call accepts the full canonical action-kind taxonomy (call_vs_jam / call_off)"),
    "gem_analyzer.py": ("e55f91c46a7d88ff6e99f0a861762962269c71813f12b570bb91940a002940ae", 593160, "v8.17.1 Iter-1 corrective: bounty stamping gated on the shared hero_in_allin_confrontation predicate; stamps per-opponent coverage + typed aggregate (supports mixed)"),
    ...
    "gem_decision_snapshot.py": ("c40ddfda4e0a42519592976615df12e260b38f7b50db5c106ebc6a53d21a6823", 23077, "v8.17.1 Iter-1 corrective: action-indexed DecisionSnapshot + RealizedContest; NO absolute dead-short threshold (pot/contest-layer logic); per-opponent mixed bounty; full action-kind taxonomy; single eff-stack source"),
