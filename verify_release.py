...
MANIFEST = {
    ...
    "_test_scratch.py": ("cdcd5524ad9d44cd40eaadc7cb6395cbab4287787b928234fe48132c564cadd5", 602926, "v8.17.1 Iter-1 corrective: T-DS rebuilt as the 13 mandatory adversarial production-path tests (no-future snapshot, mixed bounty, 3/4/5-bet + overjam taxonomy, postflop remaining stacks, dead-short participant)"),
    ...
    "gem_analyst_worklist.py": ("91a9132b01b9f62194f5cbc521311792d6e166e047777de3c9040b21da6b3c02", 50248, "v8.17.1 Iter-1 corrective: preflop-allin is_call accepts the full canonical action-kind taxonomy (call_vs_jam / call_off)"),
    "gem_analyzer.py": ("468e4031a400d6e5646d2c09fd5868415b073c0f446d76043e98268a8868a738", 591716, "v8.17.1 Iter-1 corrective: bounty stamping gated on the shared hero_in_allin_confrontation predicate; stamps per-opponent coverage + typed aggregate (supports mixed)"),
    ...
    "gem_coaching_cards.py": ("f0fb965451afaad08f65908cbbbbbfaa981fcafeb8fe359313dd37f20c3d75c4", 48926, "v8.17.1 Iter-1: blocker uses board_at_decision (no future-board reads); multiway uses canonical contesting_count (not table size); pko_pressure pinned to preflop"),
    ...
    "gem_report_draft/sections_xiv.py": ("eedbce8397800e659ad23101372e169c02e6f987147e1f23a66bb68c5a7d8b91", 238388, "v8.17.1 Iter-1: bounty-math note distinguishes an uncontested jam (no confrontation) from a genuine data gap (canonical contesting_count)"),
