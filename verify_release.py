...
MANIFEST = {
    ...
    "_test_scratch.py": ("7d2381d615a641573af033ce3bc9da4b6fe77b29ba086d1a95ddb7e16673e385", 881216, "v8.18.1: + T-VT181-01..07 (cue-first classify, word-boundary, no-truncation, provenance, alignment, 7 mutation classes, thin-no-future); T-VT-02/T-VS3-04a updated for cue-first projection + provenance keys"),
