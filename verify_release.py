...
MANIFEST = {
    ...
    "gem_analyzer.py": ("4991ca99f52bce63b990b03cd3a275b1668f6553b41c75793d96b4c5ac45f51f", 625128, "v8.17.1 Iter-1 REV13 D: the bounty icm flag names the SELECTED action (a re-jam/open-shove never restated as a 'wider call'); stamps the ledger-inferred reviewed_decision_ref onto every hand"),
    ...
    "gem_report_data.py": ("20c58517e44857304ec1789e858d35b6e993412441a6e4d2e32b2d5fdd1f55e5", 229983, "v8.17.1 Iter-1 REV16 §6: each appendix grid action carries its ledger_index so EVERY row (Hero + villain) reads the ONE full-history canonical replay"),
    ...
    "gem_report_draft/sections_tournaments.py": ("f95fe86d279e9804fd575f92a65fa9ff4d4a9e8bdbb8562b403de1c05918f1ec", 60096, "v8.18.0 final product-truth: Results finish shows place/field+Top% (No cash -> Return col); Avg Top over EVERY valid event (48.1%); BB/100+cEV signednum; sticky Regular/Turbo/Hyper speed filter"),
    ...
    "gem_report_draft/sections_xiv.py": ("79c8741fce87d5887e067a764a9d2b676e93b3a968ca15e36746105b241edb61", 285958, "v8.21 Runout Transition wiring re-pin: v8.18 status-pill paths preserved; the four _split_argument_into_notes call sites thread the hand object + a fallback derives the deterministic turn/river note when no analyst/aggression note exists (AUTO_ONLY == analyst-integrated for the same hand)"),
    "gem_report_draft/tldr.py": ("fbeb4be0a9308b2dad35cb163c54253fc7263976a99ad98a41faea0982409796", 154080, "v8.17.1 P5: review-queue stamps canonical_verdict; rq-row carries data-canonical-verdict"),
